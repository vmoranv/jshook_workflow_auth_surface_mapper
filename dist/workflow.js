...
export default createWorkflow(workflowId, 'Auth Surface Mapper')
    .description('Enumerates all authentication surfaces on a page: cookies, localStorage tokens, sessionStorage, authorization headers, JWT payloads, CSRF tokens, OAuth parameters, and API keys — producing a unified auth surface report with confidence scores.')
